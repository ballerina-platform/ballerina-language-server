...
/**
 * Represents the MySQL CDC function builder of the service model generator. Handles special-case logic for onUpdate
 * function which has two databinding parameters (beforeEntry and afterEntry) that must share the same type.
 *
 * @since 1.6.0
 */
public final class MysqlCdcFunctionBuilder extends AbstractFunctionBuilder {
